...
const std::size_t sequential_makespan){
         ...
         while(timer_replacement<10000){  //Rudementary replacement for timer. Could be changed into either input value to binary or some estimation value(some mapping from dp duration to gpu iterations)
            timer_replacement++;
